...
**hello-rails-backend** is a simple project that is aimed to practice configuring rails API.
...
- **Ability to use Rails as an API for different UI**
...
```sh
  ...
  git clone https://github.com/degisew/hello-rails-backend.git
```
...
Feel free to check the [issues page](https://github.com/degisew/hello-rails-backend/issues/).
...
This project is [MIT](https://github.com/degisew/hello-rails-backend/blob/feature/license) licensed.
